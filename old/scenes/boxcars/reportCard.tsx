...
export default makeScene2D(function* (view) {
  ...
  headers[3].text("LOSE EXACTLY $200");
  headers[4].text("LOSE LESS THAN $200");
  headers[5].text("WIN LESS THAN $570");
  headers[6].text("WIN MORE THAN $1,455");
  headers[7].text("MOST WON");
  //headers[7].text("HOUSE MONEY");
  ...
  fields[5].text("27.6 %");
  fields[6].text("3.0 %");
  fields[7].text("$2,080"); //USE R THIS IS THE p01 after group by session
