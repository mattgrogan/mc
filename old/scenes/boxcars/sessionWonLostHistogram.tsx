...
import winlose from "../../../../dicedata/output/boxcars-100k/boxcars-100k-amount-wonlost-quantiles.json";

// -session_hist.json
import histogramData from "../../../../dicedata/output/boxcars-100k/boxcars-100k-session_hist.json";
...
export default makeScene2D(function* (view) {
  ...
  let bar = 4; //Math.floor(histogramData.length / 2);
  let bars = [bar];
  yield* all(
    // chart().highlightBar(lowerBar, Bright.ORANGE),
    chart().highlightBar(bar, Bright.ORANGE)
  );
  yield* chart().moveBox(
    histogramData[bar].cuts,
    histogramData[bar + 1].cuts,
