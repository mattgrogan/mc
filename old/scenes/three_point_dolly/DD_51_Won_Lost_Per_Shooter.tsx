...
// PLOT OPTIONS
const X_AXIS_MIN = -15000;
const X_AXIS_MAX = 10000;
const X_AXIS_STEP = 500;
const Y_AXIS_MAX = 25;
const X_TICKS_EVERY = 2;
const PCT_FONT_SIZE = 16;
...
export default makeScene2D(function* (view) {
  ...
  // RESCALE
  yield* plot().rescale(-50000, 10000, 5000, 0, Y_AXIS_MAX, 10, 5);
