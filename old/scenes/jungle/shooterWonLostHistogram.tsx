...
import histogramData from "../../../../dicedata/output/jungle-100k/jungle-100k-shooter_winloss_histogram.json";
...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Camera ref={camera}>
      <HistogramV2
        ...
        //
        barLineProps={{ lineWidth: 40, stroke: Bright.BLUE }}
        minMaxRectProps={{
          fill: Grays.BLACK,
  ...
  yield* all(
    chart().highlightBar(4, Bright.BLUE),
    chart().highlightBar(5, Bright.ORANGE),
    chart().moveBox(
      histogramData[5].cuts,
      histogramData[6].cuts,
      chart().getPercentForBars([5])
    )
  );
  yield* waitFor(1);
