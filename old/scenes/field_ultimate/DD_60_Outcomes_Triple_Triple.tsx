...
const WINNERS = params.winlose.find((stat: any) => stat.STAT == "N_UP").BY_SESSION;
const PUSHERS = params.winlose.find((stat: any) => stat.STAT == "N_EVEN").BY_SESSION;
const LOSERS = params.winlose.find((stat: any) => stat.STAT == "N_DOWN").BY_SESSION;
const TOTAL = params.winlose.find((stat: any) => stat.STAT == "N").BY_SESSION;
