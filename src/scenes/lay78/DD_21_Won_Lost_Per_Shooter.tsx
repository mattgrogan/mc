...
import dataImport from "../../../../dicedata/output/lay78-100k/json/hist_hand_shcwonlost.v1.json";
// quantiles_hand_shcwonlost.v1.json
import quantilesImport from "../../../../dicedata/output/lay78-100k/json/quantiles_hand_shcwonlost.v1.json";

const DATA = dataImport["VigOnWin"];
const QUANTILES = quantilesImport["VigOnWin"];

const title = createSignal(
  "How much did the bots\nwin or lose during a shooter?"
);
const TITLE_POSITION = new Vector2(-1600, -500);
