...
// house_edge.v1.json
import houseEdgeData from "../../../../dicedata/output/lay78-100k/json/house_edge.v1.json";
// throw_hit_rate.v1.json
import throwHitRateData from "../../../../dicedata/output/lay78-100k/json/throw_hit_rate.v1.json";
...
const STRATEGIES_DATA = [
  {
    name: "Vig on Win",
    houseEdge: houseEdgeData.VigOnWin,
    throwHitRate: throwHitRateData.VigOnWin,
  },
  {
    name: "Vig Upfront",
