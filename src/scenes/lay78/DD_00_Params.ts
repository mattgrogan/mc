...
// Data Configuration
export const SIM_NAME = "lay78";
export const RUN_NAME = "100k";
export const PLAYER_NAME = "VigOnWin";

// Import all data files for this simulation (must use literal paths)

// overall_stats.v1.json
import overallStatsImport from "../../../../dicedata/output/lay78-100k/json/overall_stats.v1.json";
import outcomesHandImport from "../../../../dicedata/output/lay78-100k/json/outcomes_by_hand.v1.json";
import outcomesSessionImport from "../../../../dicedata/output/lay78-100k/json/outcomes_by_session.v1.json";
