...
// PLOT OPTIONS
const DATA = data.SHOOTER_OUTLAY.PLYR_15;
...
const PCT_FONT_SIZE = 20;
const BAR_WIDTH = 60;

// ADJUSTMENTS: NEG TO LEFT, POS TO RIGHT
const MIN_OFFSET = -50;
const P05_OFFSET = -250;
const P25_OFFSET = -50;
const AVG_OFFSET = -60;
const MEDIAN_OFFSET = 0;
const P75_OFFSET = 0;
const P95_OFFSET = 0;
const MAX_OFFSET = 25;
...
export default makeScene2D(function* (view) {
  ...
  // MINIMUM
  const min = createLabelAndPointer({
    ...DEFAULTS_LABEL_AND_POINTER,
    plot: plot,
  ...
  // MAX
  const max = createLabelAndPointer({
    ...DEFAULTS_LABEL_AND_POINTER,
    plot: plot,
  ...
  // MOST LOST
  yield* FadeIn(min.valueLabel, 0.6, easeOutCubic, [0, 50]);
  yield* min.arrow.end(1, 1, easeInOutCubic);

  // MOST WON
  yield* FadeIn(max.valueLabel, 0.6, easeOutCubic, [0, 50]);
  yield* max.arrow.end(1, 1, easeInOutCubic);
