...
export default makeScene2D(function* (view) {
  ...
  dataTable.valueRects[0].fill(grayGradient); // 2
  dataTable.valueRects[1].fill(grayGradient); // 3
  dataTable.valueRects[2].fill(greenGradient); // 4
  dataTable.valueRects[3].fill(grayGradient); // 5
  dataTable.valueRects[4].fill(grayGradient); // 6
  dataTable.valueRects[5].fill(redGradient); // 7
  dataTable.valueRects[6].fill(grayGradient); // 8
  dataTable.valueRects[7].fill(grayGradient); // 9
  dataTable.valueRects[8].fill(grayGradient); // 10
  dataTable.valueRects[9].fill(grayGradient); // 11
  dataTable.valueRects[10].fill(grayGradient); // 12
  ...
  const redColor = "#bd2227";
  const greenColor = "#3b8f50";

  const sevenBox = createRef<Line>();
  view.add(
    <Line
      ref={sevenBox}
      // fill={"#0b431e"}
  ...
  const elevenBox = createRef<Line>();
  view.add(
    <Line
      ref={elevenBox}
      // fill={"#0b431e"}
  ...
  yield* sequence(
    0.3,
    sevenBox().end(1, 2, easeInOutCubic),
    fourBox().end(1, 2, easeInOutCubic)
  );

  yield sevenBox().fill("#0b431e60", 1);
  // yield* elevenBox().fill("#0b431e60", 1);
