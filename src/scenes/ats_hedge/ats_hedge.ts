...
import DD_40_House_Take_And_Edge_ATSONLY from "./DD_40_House_Take_And_Edge_ATSONLY?scene";
...
import DD_61_Won_Lost_Per_Session_BASELINE from "./DD_61_Won_Lost_Per_Session_BASELINE?scene";
import DD_62_Outlay_Per_Session from "./DD_62_Outlay_Per_Session?scene";
import DD_62_Outlay_Per_Session_BASELINE from "./DD_62_Outlay_Per_Session_BASELINE?scene";
import DD_63_Outlay_by_Hour from "./DD_63_Outlay_by_Hour?scene";
import DD_64_Win_Vs_Outlay from "./DD_64_Win_Vs_Outlay?scene";
import DD_64_Win_Vs_Outlay_BASELINE from "./DD_64_Win_Vs_Outlay_BASELINE?scene";

import DD_70_Wins_Per_Bet from "./DD_70_Wins_Per_Bet?scene";
import DD_71_Loss_Per_Bet from "./DD_71_Loss_Per_Bet?scene";

import DD_80_Comparison_Won_Lost from "./DD_80_Comparison_Won_Lost?scene";
// import DD_81_Comparison_Outlay from "./DD_81_Comparison_Outlay?scene";
...
export default makeProject({
  scenes: [
    ...
    DD_61_Won_Lost_Per_Session_BASELINE,
    DD_61_Won_Lost_Per_Session,
    DD_80_Comparison_Won_Lost,

    // Bankroll
    DD_62_Outlay_Per_Session,
    DD_62_Outlay_Per_Session_BASELINE,
    // DD_63_Outlay_by_Hour,
    DD_64_Win_Vs_Outlay,
    DD_64_Win_Vs_Outlay_BASELINE,
    ...
    // Comparisons
    // DD_81_Comparison_Outlay, // THIS DOES NOT WORK

    // // Casino View
    DD_40_House_Take_And_Edge,
    DD_40_House_Take_And_Edge_ATSONLY,
  ],
});
