...
const title = createSignal("How much did the \nbots outlay during a session?");
const TITLE_POSITION = new Vector2(-1200, -800);

// PLOT OPTIONS
const DATA = data.SESSION_OUTLAY.ATS_Baseline;
const X_AXIS_MIN = Math.max(DATA.HIST_MIN, 0); // always start at zero
