...
//-sessions.json
import simData from "../../../../dicedata/output/lay_the_point-100k/lay_the_point-100k-sessions.json";
//-all-sessions.json
import sessions from "../../../../dicedata/output/lay_the_point-100k/lay_the_point-100k-all_sessions.json";
