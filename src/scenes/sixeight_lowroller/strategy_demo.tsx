...
import simData from "../../../../dicedata/output/sixeightlowroller-stratdemo/sixeightlowroller-stratdemo-sessions.json";
    ...
    <Camera ref={camera}>
      ...
      >
        ...
        >
          ...
          <Txt
            {...PoppinsWhite}
            text={"Place 6 and 8 for $18 each."}
            textWrap={"wrap"}
          ></Txt>
        </Rect>
        <Rect
        ...
        >
          ...
          <Txt
            {...PoppinsWhite}
            text={"Either hits, press to $30 each."}
            textWrap={"wrap"}
          ></Txt>
        </Rect>
        <Rect
