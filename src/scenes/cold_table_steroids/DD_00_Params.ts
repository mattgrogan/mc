export const name = "Cold Table on Steroids";
export const sessions = "100,000";
export const shooters_per_session = "10";
export const table_min = "$10";
export const table_max = "$1,000";

import dataImport from "../../../../dicedata/output/cold_table_on_steroids-100k/cold_table_on_steroids-100k-overall_stats.json";
