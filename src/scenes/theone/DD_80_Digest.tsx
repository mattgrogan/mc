...
// house_edge.v1.json
import houseEdgeData from "../../../../dicedata/output/theone-100k-newreport/json/house_edge.v1.json";
...
const STRATEGIES_DATA = [
  {
    name: "Strategy A",
    houseEdge: houseEdgeData.TheOne,
    throwHitRate: throwHitRateData.TheOne,
  },
  {
    name: "Strategy B",
    houseEdge: houseEdgeData.TheOne, // Using same data for now
    throwHitRate: throwHitRateData.TheOne, // Using same data for now
  },
];
