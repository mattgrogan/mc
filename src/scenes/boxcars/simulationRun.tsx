...
import simstats from "../../../../dicedata/output/boxcars-100k/boxcars-100k-sessions-shooters-rolls.json";
import casinostats from "../../../../dicedata/output/boxcars-100k/boxcars-100k-casinostats.json";
...
export default makeScene2D(function* (view) {
  ...
  sim.name = "BoxCars $200 -> $1,500";
  sim.options = "-";
  sim.sessions = simstats[0].SESSIONS;
  sim.shooters = "30 Per Session";
  sim.tableMin = "$5";
  sim.tableMax = "$5,000";
