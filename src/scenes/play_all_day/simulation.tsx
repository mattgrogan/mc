...
import simstats from "../../../../dicedata/output/play_all_day-100k/play_all_day-100k-sessions-shooters-rolls.json";
import casinostats from "../../../../dicedata/output/play_all_day-100k/play_all_day-100k-casinostats.json";
