export const name = "Three Point Molly";
export const sessions = "100,000";
export const shooters_per_session = "10";
export const table_min = "$50";
export const table_max = "$5,000";

import dataImport from "../../../../dicedata/output/three_point_molly_working-100k/three_point_molly_working-100k-overall_stats.json";
