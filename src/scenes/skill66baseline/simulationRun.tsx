...
import simstats from "../../../../dicedata/output/skill66baseline-100k/skill66baseline-100k-sessions-shooters-rolls.json";
import casinostats from "../../../../dicedata/output/skill66baseline-100k/skill66baseline-100k-casinostats.json";
