...
//-sessions.json
import simData from "../../../../dicedata/output/hybrid_reverse_arnold_ladder-test/hybrid_reverse_arnold_ladder-test-sessions.json";
//-all-sessions.json
import sessions from "../../../../dicedata/output/hybrid_reverse_arnold_ladder-test/hybrid_reverse_arnold_ladder-test-all_sessions.json";
