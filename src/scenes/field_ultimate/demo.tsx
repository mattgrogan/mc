...
//-sessions.json
import simData from "../../../../dicedata/output/field_triple-100k/field_triple-100k-sessions.json";
//-all-sessions.json
import sessions from "../../../../dicedata/output/field_triple-100k/field_triple-100k-all_sessions.json";
