...
import simData from "../../../../dicedata/output/ken_440_regress-100k-newreport/sessions/ken_440_regress-100k-newreport-440Regress-best-8.json";
...
const TEST_CONFIG = {
  ...
  maxRounds: 50, // Test with first 50 rounds only
};
