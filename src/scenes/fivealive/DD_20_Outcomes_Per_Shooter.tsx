...
import byhand from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/outcomes_by_hand.v1.json";
// outcomes_by_session.v1.json
import bySession from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/outcomes_by_session.v1.json";

const byHandData = byhand[PLAYER_NAME];
const bySessionData = bySession[PLAYER_NAME];
