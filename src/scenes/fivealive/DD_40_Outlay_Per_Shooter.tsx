...
import dataImport from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/hist_hand_outlay.v1.json";
// quantiles_hand_outlay.v1.json
import quantilesImport from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/quantiles_hand_outlay.v1.json";

const DATA = dataImport[PLAYER_NAME];
const QUANTILES = quantilesImport[PLAYER_NAME];

const title = createSignal("Total Outlay per Shooter");
