...
// hist_hand_shcwonlost.v1.json
import dataImport from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/hist_hand_shcwonlost.v1.json";
// quantiles_hand_shcwonlost.v1.json
import quantilesImport from "../../../../dicedata/output/y2025/m07/fivealive-100k/json/quantiles_hand_shcwonlost.v1.json";

const DATA = dataImport[PLAYER_NAME];
const QUANTILES = quantilesImport[PLAYER_NAME];

const title = createSignal("Profit and Loss per Shooter");
const subtitle = createSignal(
  `Histogram of outcomes from ${commaFormmatter(QUANTILES.N)} individual hands.`
);
