...
const GROUP000 = 0;
const GROUP100 = 10212;
const GROUP200 = 17088;
const GROUP300 = 21801;
const GROUP400 = 26101;
const GROUP500 = 20733;
const GROUP600 = 4048;
const GROUP700 = 17;
const GROUP800 = 0;
const GROUP900 = 0;
...
export default makeScene2D(function* (view) {
  ...
  yield* all(
    box().end(0, 1, easeInOutCubic),
    FadeOut(cumPctLabel, 1, easeInOutCubic)
  );
  yield* waitFor(1);
