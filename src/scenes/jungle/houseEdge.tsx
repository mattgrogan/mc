...
import casinostats from "../../../../dicedata/output/jungle-100k/jungle-100k-casinostats.json";
...
const HOUSE_EDGE_LABEL =
  "THE JUNGLE (" + (HOUSE_EDGE_PERCENT * -1).toFixed(3) + "%)";
...
export default makeScene2D(function* (view) {
  ...
  const skill66Label = plot().text([-30, HOUSE_EDGE_PERCENT], {
    //...MonoWhite,
    ...PoppinsWhite,
    fontWeight: 500,
    fontSize: 40,
