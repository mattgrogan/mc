...
import dataImport from "../../../../dicedata/output/wgs_tweak-100k-newreport/json/hist_session_cwonlost.v1.json";
const DATA = dataImport.PLYR;
import quantilesImport from "../../../../dicedata/output/wgs_tweak-100k-newreport/json/quantiles_session_cwonlost.v1.json";
