...
import dataImport from "../../../../dicedata/output/wgs_tweak-100k-newreport/json/hist_session_outlay.v1.json";
const DATA = dataImport.PLYR;
import quantilesImport from "../../../../dicedata/output/wgs_tweak-100k-newreport/json/quantiles_session_outlay.v1.json";
const QUANTILES = quantilesImport.PLYR;
const title = createSignal("How much did the bots\noutlay during a shooter?");
const TITLE_POSITION = new Vector2(-1500, -600);
