...
//-sessions.json
import simData from "../../../../dicedata/output/wgs_tweak-100k/wgs_tweak-100k-sessions.json";
//-all-sessions.json
import sessions from "../../../../dicedata/output/wgs_tweak-100k/wgs_tweak-100k-all_sessions.json";
