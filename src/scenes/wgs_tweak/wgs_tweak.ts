...
import DD_50_Outcomes_Per_Shooter_New from "./DD_50_Outcomes_Per_Shooter_New?scene";
...
import DD_64_Session_Yield from "./DD_64_Session_Yield?scene";

import DD_70_Wins_Per_Bet from "./DD_70_Wins_Per_Bet?scene";
import DD_71_Loss_Per_Bet from "./DD_71_Loss_Per_Bet?scene";

import DD_90_Throws_to_Profit from "./DD_90_Throws_to_Profit?scene";
...
export default makeProject({
  scenes: [
    // Shooter Hands
    DD_50_Outcomes_Per_Shooter_New,
