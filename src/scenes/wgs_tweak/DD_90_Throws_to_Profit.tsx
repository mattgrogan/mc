...
import dataImport from "../../../../dicedata/output/wgs_tweak-100k-newreport/json/throws_to_profit.v1.json";
const cover4press = dataImport.PLYR;
...
export default makeScene2D(function* (view) {
  ...
  // Highlight First Row
  yield* tabled().scrollToRow(37, 5);
  yield* tabled().highlightRow(37, { fill: tw_colors.yellow[700] });
  yield* waitFor(3);
  yield* tabled().removeHighlighters();

  //   yield* waitFor(1);
  // Highlight Second Row
  // yield* tabled().highlightRow(7, { fill: tw_colors.yellow[700] });
  // yield* waitFor(3);
  // yield* tabled().removeHighlighters();
