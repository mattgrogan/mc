...
export default makeScene2D(function* (view) {
  ...
  // HIGHLIGHT THE BIMODAL BOXES
  const box = plot().box([-1350, 60], [-1050, -2], {
    stroke: Darker.ORANGE,
    lineWidth: 20,
    lineDash: [20, 5],
    end: 0,
  });
  yield* box.end(1, 2, easeInOutCubic);
  yield* waitFor(1);
  yield* box.shiftPositionTo([250, 30], [900, -2], 3, easeInOutCubic);
  yield* waitFor(2);
  yield* box.start(1, 2, easeInOutCubic);
  box.remove();
