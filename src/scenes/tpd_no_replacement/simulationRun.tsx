...
import simstats from "../../../../dicedata/output/3pd_no_replacement-100k/3pd_no_replacement-100k-sessions-shooters-rolls.json";
import casinostats from "../../../../dicedata/output/3pd_no_replacement-100k/3pd_no_replacement-100k-casinostats.json";
