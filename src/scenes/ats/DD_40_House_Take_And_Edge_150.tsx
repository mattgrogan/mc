...
// const TOTAL_BET = params.data.OVERALL_STATS.PLYR_150.TOTAL_BET
...
export default makeScene2D(function* (view) {
  ...
  rowValues[0].text(commaFormmatter(params.data.OVERALL_STATS.PLYR_150.DROP));
  rowValues[1].text(commaFormmatter(TOTAL_BET));
  rowValues[2].text(
    plusCommaFormmatter(params.data.OVERALL_STATS.PLYR_150.TOTAL_WON)
  );
  rowValues[3].text(
    commaFormmatter(params.data.OVERALL_STATS.PLYR_150.TOTAL_LOST)
  );
  rowValues[4].text(
    commaFormmatter(params.data.OVERALL_STATS.PLYR_150.HOUSE_TAKE)
  );
  rowValues[5].text(
    commaFormmatter(params.data.OVERALL_STATS.PLYR_150.HOUSE_EDGE * 100, 3) +
      "%"
  );
  // ADD THE PLOT AREA
  ...
  const HOUSE_EDGE_PERCENT =
    params.data.OVERALL_STATS.PLYR_150.HOUSE_EDGE * 100;
