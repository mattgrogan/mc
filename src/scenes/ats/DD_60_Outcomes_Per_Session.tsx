...
const WINNERS = params.data.OUTCOMES_BY_SESSION.PLYR_175.N_UP;
const PUSHERS = params.data.OUTCOMES_BY_SESSION.PLYR_175.N_EVEN;
const LOSERS = params.data.OUTCOMES_BY_SESSION.PLYR_175.N_DOWN;
const TOTAL = params.data.OUTCOMES_BY_SESSION.PLYR_175.N;
