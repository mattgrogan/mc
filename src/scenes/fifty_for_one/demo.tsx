...
//-sessions.json
import simData from "../../../../dicedata/output/fifty_for_one-100k/fifty_for_one-100k-sessions.json";
//-all-sessions.json
import sessions from "../../../../dicedata/output/fifty_for_one-100k/fifty_for_one-100k-all_sessions.json";
