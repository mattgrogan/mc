...
import data from "../../../../dicedata/output/ehackstate95-100k2/json/hist_session_cwonlost.v1.json";
import quantiles from "../../../../dicedata/output/ehackstate95-100k2/json/quantiles_session_cwonlost.v1.json";

// PLOT OPTIONS
const DATA = data.Strategy1;
const QUANTILES = quantiles.Strategy1;
...
export default makeScene2D(function* (view) {
  ...
  const tableData = [
    { label: "MIN", value: plusCommaFormmatter(QUANTILES.MIN) },
    ...
    { label: "MAX", value: plusCommaFormmatter(QUANTILES.MAX) },
  ];
