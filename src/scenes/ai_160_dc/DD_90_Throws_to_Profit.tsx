...
import datac from "../../../../dicedata/output/ai160dc-100k/ai160dc-100k-overall_stats.json";
...
const cover4press = datac.ROLLS_TO_PROFIT.AI160DC;
...
export default makeScene2D(function* (view) {
  ...
  // Highlight First Row
  yield* tabled().highlightRow(4, { fill: tw_colors.yellow[700] });
  yield* waitFor(3);
