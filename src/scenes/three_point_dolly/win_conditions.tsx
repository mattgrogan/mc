...
export default makeScene2D(function* (view) {
    ...
    dataTable.valueRects[2].fill(redGradient)
    ...
    dataTable.valueRects[9].fill(grayGradient)
    ...
    view.add(
        <Line ref={loseBox}
            // fill={"#7c0d28"}
            closed
            points={[[-900, -140], [-650, -140], [-650, 300], [-900, 300]]}
            stroke={"#bd2227"}
            lineWidth={10}
            zIndex={-100}
            radius={20}
    ...
    view.add(
        ...
        // fill={"#0b431e"}
        closed
        points={[[-130, -500], [130, -500], [130, 300], [-130, 300]]}
        stroke={"#3b8f50"}
        lineWidth={10}
        zIndex={-100}
        radius={20}
